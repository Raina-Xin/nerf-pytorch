...
def config_parser():
    ...
    parser.add_argument("--gpu_idx", type=int, help="index of gpu")
...
def train():
    ...
    for i in trange(start, N_iters):
        ...
        optimizer.zero_grad()
        img_loss = img2msle(rgb, target_s)
        trans = extras["raw"][..., -1]
        loss = img_loss
        psnr = mse2psnr(img_loss)

        if "rgb0" in extras:
            img_loss0 = img2msle(extras["rgb0"], target_s)
            loss = loss + img_loss0
